...
pizzerias_export = ("https://gist.githubusercontent.com/leplatrem/887e61efc1a7dfc7a68bcdf170d1ced9"
...
with client.batch() as batch:
    for pizzeria in export["features"]:
        record = {
            ...
            "_geoloc": {
                "lng": pizzeria["geometry"]["coordinates"][0],
                "lat": pizzeria["geometry"]["coordinates"][1],
            }
        }
